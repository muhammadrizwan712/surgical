...
<form method="post" action="{{route('store.color')}}" >
	{{csrf_field()}}

<div class="col-md-12">
	
	<div class="col-md-3" style="margin-top: 10px">
		<input type="text" name="name" required="true" placeholder="Enter Color Name">
	</div>
...
<div class="row">
  ...
  <h2 style="text-align: center;color:  blue">COLOR SETTING</h2>
        ...
        <tbody>
          @foreach($color as $cls)
            <tr>
                ...
                <a href="{{route('delete.color',$cls->id)}}" class="btn btn-xs btn-danger"><i class="glyphicon glyphicon-remove"></i> Delete</a>
