  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="text-align: center">Edit Size</h4>
      </div>
...
<form method="post" action="{{route('store.size')}}" >
	{{csrf_field()}}

<div class="col-md-12">
	
	<div class="col-md-3" style="margin-top: 10px">
		<input type="text" name="name" required="true" placeholder=" size Name">
	</div>
...
<div class="row">
  ...
  <h2 style="text-align: center;color:  blue">SIZES SETTING</h2>
        ...
        <tbody>
          @foreach($size as $cls)
            <tr>
                ...
                <a href="{{route('delete.size',$cls->id)}}" class="btn btn-xs btn-danger"><i class="glyphicon glyphicon-remove"></i> Delete</a>
