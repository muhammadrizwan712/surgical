        ...
        <tbody>
          @foreach($serial as $cls)
            <tr>
                ...
                <a href="{{route('delete.serial',$cls->id)}}" class="btn btn-xs btn-danger"><i class="glyphicon glyphicon-remove"></i> Delete</a>
