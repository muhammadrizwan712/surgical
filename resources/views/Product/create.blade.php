  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="text-align: center">Edit Item</h4>
      </div>
...
<div class="col-md-12">
	...
	<div class="col-md-3" style="margin-top: 10px">
		<input type="text" name="name" required="true" placeholder=" Product Name">
	</div>
...
<div class="row">
  ...
  <h2 style="text-align: center;color:  blue">PRODUCT SETTING</h2>
        ...
        <tbody>
          @foreach($product as $cls)
            <tr>
                ...
                <a href="{{route('delete.product',$cls->id)}}" class="btn btn-xs btn-danger"><i class="glyphicon glyphicon-remove"></i> Delete</a>
